...
for i in range(256):
    program += 'bitsadder_128 c_num_' + str(i) + '(.data_in(dot_col_' + str(i) + '), .sum(check_col_' + str(i) + '));\n'

program += '\n\n'

for i in range(256):
    program += 'bitsadder_128 w_num_' + str(i) + '(.data_in(dot_col_' + str(i) + ' & form_array), .sum(wrong_col_' + str(i) + '));\n'
